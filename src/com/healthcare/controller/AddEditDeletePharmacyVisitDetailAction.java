...
/**
 * Servlet implementation class AddEditDeletePharmacyVisitDetailAction
 */
@WebServlet("/AddEditDeletePharmacyVisitDetailAction")
public class AddEditDeletePharmacyVisitDetailAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddEditDeletePharmacyVisitDetailAction() {
        super();
		...
		if (buttons.equalsIgnoreCase("SAVE")) {
			...
			try {
				...
				if (visitDetail == null) {
					...
					appointmentForm.setPharmacyId(pharmacyId);
				...
				visitDetail.setPharmacyId(pharmacyId);
			...
			appointmentForm.setDoctorId(id);
