...
/**
 * Servlet implementation class PharmacyViewAppointment
 */
@WebServlet("/PharmacyViewAppointment")
public class PharmacyViewAppointment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PharmacyViewAppointment() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request
				.getRequestDispatcher("pharmacyViewAppointments.jsp");
		...
		if(submitBtn.equalsIgnoreCase("SAVE")){
			...
			appointmentList=appointmentDetailDao.savePharmacyAppointments(appointIdsChecked,pharmacyId);
