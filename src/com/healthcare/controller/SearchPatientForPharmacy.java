...
/**
 * Servlet implementation class SearchPatientForPharmacy
 */
@WebServlet("/SearchPatientForPharmacy")
public class SearchPatientForPharmacy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchPatientForPharmacy() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("patientSerachForPharmacy.jsp");
