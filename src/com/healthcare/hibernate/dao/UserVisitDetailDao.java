...
public class UserVisitDetailDao {
	private static UserVisitDetailDao userAppointmentDetailDao;
	
	private UserVisitDetailDao() {}
	
	public static UserVisitDetailDao getInstance(){
		if(null == userAppointmentDetailDao){
			userAppointmentDetailDao = new UserVisitDetailDao();
		}
	...
	public static void main(String[] args) {
		UserVisitDetailDao dao = UserVisitDetailDao.getInstance();
